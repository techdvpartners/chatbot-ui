    ...
    'default': () => {
      ...
      if (requestSource === googleAssistantRequest) {
        let responseToUser = {
          ...
          speech: 'This message is from Dialogflow\'s Cloud Functions for Firebase editor! google v1 speech', // spoken response
          text: 'This is from Dialogflow\'s Cloud Functions for Firebase editor! google v1 text:-)' // displayed response
        };
        ...
        let responseToUser = {
          ...
          text: 'This is from Dialogflow\'s Cloud Functions for Firebase editor! v1 Text :-)' // displayed response
        };
  ...
  const actionHandlers = {
    ...
    'default': () => {
      let responseToUser = {
        ...
        fulfillmentText: 'This is from Dialogflow\'s Cloud Functions for Firebase editor! v2:-)' // displayed response
        //fulfullmentText: request
      };
      sendResponse(responseToUser);
    }
  };
